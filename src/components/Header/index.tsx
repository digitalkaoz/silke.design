  ...
  <header>
    <div className="logo-column">
      ...
      <div className="headline">
        <h1>Hi! I&apos;m Silke,</h1>
        <p>
          a Product-Designer based in Hamburg, with 20 years of professional experience. I bring
          ideas to life through creativity, thoughtful designs and collaboration with engineers.
        </p>
      </div>
    </div>

    <div className="profile-column">
      <div className="tk-blob" style={{ '--fill': '#86F4D7' }}>
      ...
      <img src="/img/profile.png" alt="Silke Schönthal - Product Designer" />
    </div>
  </header>
);
