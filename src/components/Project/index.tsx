...
const Text: FunctionComponent<ProjectProps> = ({
    ...
    <>
        ...
        <h3>Kunde</h3>
        {customer.length == 2 ?
            <p><a href={customer[1]} target="_blank" rel="nofollow" dangerouslySetInnerHTML={{__html: customer[0]}}></a>
            </p> : <p dangerouslySetInnerHTML={{__html: customer[0]}}></p>}
        {employer && employer.length == 2 ?
            <p><a href={employer[1]} target="_blank" rel="nofollow" dangerouslySetInnerHTML={{__html: employer[0]}}></a>
            </p> : employer ? <p dangerouslySetInnerHTML={{__html: employer[0]}}></p> : <></>}
    </>
)
